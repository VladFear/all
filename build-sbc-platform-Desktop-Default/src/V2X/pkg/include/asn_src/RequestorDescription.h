 ...
 * From ASN.1 module "RequestorDescriptionFrameModule"
 * 	found in "./RequestorDescriptionFrameModule.asn"
 * 	`asn1c -gen-PER`
 */
...
extern asn_TYPE_member_t asn_MBR_RequestorDescription_1[8];
